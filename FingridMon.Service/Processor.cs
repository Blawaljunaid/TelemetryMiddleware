...
namespace FingridMon.Service
{
    public class Processor : BackgroundService
    {
            ...
            System.Threading.Thread thWorker = new System.Threading.Thread(new System.Threading.ThreadStart(
               ...
               async delegate
               {
                   try
                   {
                       ...
                       processors.Add(new Fingrid.Monitoring.IRestrictProcessor(loader,institutions));
        ...
        public async Task<List<Institution>> LoadRecovaInstitutionsAsync()
        {
            ...
            try
            {
                institutions = await Fingrid.Monitoring.Utility.InstitutionInfo.GetRecovaInstitutions();
            ...
            {
                Logger.Log("Error getting Recova Institutions: {0}", ex.Message);
                return institutions;
